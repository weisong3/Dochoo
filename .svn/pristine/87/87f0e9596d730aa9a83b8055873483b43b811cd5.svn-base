...
public class RegisterPresenter extends AbstractAccountPresenter {
    ...
    public void registerPatient(RegisterPatientInfo info, String pushId) {
	...
	private boolean checkPatientField(String email, String password, String passwordConfirm, String firstname, String lastname,
	...
	public void registerPhysician(RegisterPhysicianInfo info, String pushId) {
	...
	private boolean checkPhysicianField(
            String email,
            String password,
    ...
    public void registerMedicalGroup(RegisterCenterInfo info, String pushId) {
	...
	private boolean checkMedicalGroupField(String email, String password, String passwordConfirm, String centerName) {
		boolean result = true;
