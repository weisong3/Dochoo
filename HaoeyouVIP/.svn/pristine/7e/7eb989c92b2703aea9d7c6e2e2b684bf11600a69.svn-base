...
public class UserRoleSelectActivity extends ActionBarActivity {
    private static String activateType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if (savedInstanceState == null) {
           ...
           if(extras == null) {
               ...
               activateType = extras.getString("activateType","");
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            for (int i = 0; i < wrappers.size(); i++) {
                final int index = i;
                if(StringUtils.equals(activateType.substring(i,i+1),"1")){
                    wrappers.get(i).setEnabled(true);
                ...
                else    wrappers.get(i).setAlpha(0.5f);
            }
